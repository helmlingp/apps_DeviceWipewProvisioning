...
if ($Reset) {
  ...
  if ($FileExists) {
    ...
    $methodName = "doWipePersistProvisionedDataMethod" #https://docs.microsoft.com/en-us/windows/client-management/mdm/remotewipe-csp methods with "Method" appended
